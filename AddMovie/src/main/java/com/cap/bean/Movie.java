...
public class Movie {
	...
	public String toString() {
		return "Movie [movie_Id=" + movie_Id + ", movie_Name=" + movie_Name + ", movie_Genre=" + movie_Genre
				+ ", movie_Director=" + movie_Director + ", movie_Length=" + movie_Length + ", languages=" + languages
